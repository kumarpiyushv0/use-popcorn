...
//useEffect is used when execution required at initial render
//abort controller is a browser native api used to remove race conditions
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader/>}
          {!isLoading && !error && <MovieList movies={movies} onSelectMovies={handleSetSelectedId}/>}
